...
namespace EmployePayroll
{
    ...
    {
        public static string connectionString = @"Server=DESKTOP-1AIO5K2\TEW_SQLEXPRESS;Database=Payroll_Service;Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true";
	...
	BasicPay,Deduction,TaxablePay,Tax,NetPay,City,Country from Day33_Payroll_Service";
        ...
        public bool AddEmployee(EmployeeModel employeeModel)
        {
            try
            {
                using (connection)
                {
                    SqlCommand command = new SqlCommand("SpAddEployeedetails", connection);
